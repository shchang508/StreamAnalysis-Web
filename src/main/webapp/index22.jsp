...
<body>
	<div class="alert">
		<span class="closebtn"
			...
			up! </strong> Please check you launch the TSReader first.
	</div>
	<form action="f1" method="post" id="formPath" target="exportFrame">
		<h1>
			Stream Analysis <span class="span">with TSReader</span>
		</h1>

		<div class="box">
			<input class="textField" type="text" id="t1" name="filePath"
				placeholder="Enter path" />


			<button id="button" class="submitBtn" value="btnValue">
...
<script type="text/javascript">
	...
	var func = function hello() {
		...
		var form = document.getElementById("formPath");
		form.submit();
	}
